...
public class ToolSelector : MonoBehaviour {
    ...
    private void ManagePickaxeSystem() {
        ...
        if(hit.collider) {
            ...
            if(WorldManager.instance.worldMapTile[x, y] > 0) {
                ...
                if(this.TileCanBeDestroyed(x, y)) {
                    ...
                    if(this.selectedTilePosition != new Vector2Int(x, y)) {
                        ...
                        this.currentTileConfig = (BlockConfig)ItemManager.instance.GetItemWithId(WorldManager.instance.worldMapTile[x, y]);
                    }
    ...
    private bool TileCanBeDestroyed(int posX, int posY) {
        int itemIdToCompare = WorldManager.instance.worldMapObject[posX, posY + 1];
