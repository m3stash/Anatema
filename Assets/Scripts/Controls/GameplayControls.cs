...
public partial class @GameplayControls: IInputActionCollection2, IDisposable
{
    ...
    private List<IToolSelectorActions> m_ToolSelectorActionsCallbackInterfaces = new List<IToolSelectorActions>();
    ...
    public struct ToolSelectorActions
    {
        ...
        public void AddCallbacks(IToolSelectorActions instance)
        {
            if (instance == null || m_Wrapper.m_ToolSelectorActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ToolSelectorActionsCallbackInterfaces.Add(instance);
            @PressClick.started += instance.OnPressClick;
            @PressClick.performed += instance.OnPressClick;
            @PressClick.canceled += instance.OnPressClick;
            @ReleaseClick.started += instance.OnReleaseClick;
        ...
        private void UnregisterCallbacks(IToolSelectorActions instance)
        {
            @PressClick.started -= instance.OnPressClick;
            @PressClick.performed -= instance.OnPressClick;
            @PressClick.canceled -= instance.OnPressClick;
        ...
        public void RemoveCallbacks(IToolSelectorActions instance)
        {
            if (m_Wrapper.m_ToolSelectorActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IToolSelectorActions instance)
        {
            foreach (var item in m_Wrapper.m_ToolSelectorActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ToolSelectorActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
