...
//     version 1.7.0
//     from Assets/Scripts/Controls/MainMenuControls.inputactions
//
...
public partial class @MainMenuControls: IInputActionCollection2, IDisposable
{
    ...
    private List<ILeftMenuActions> m_LeftMenuActionsCallbackInterfaces = new List<ILeftMenuActions>();
    ...
    public struct LeftMenuActions
    {
        ...
        public void AddCallbacks(ILeftMenuActions instance)
        {
            if (instance == null || m_Wrapper.m_LeftMenuActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_LeftMenuActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ILeftMenuActions instance)
        {
            @Navigate.started -= instance.OnNavigate;
            @Navigate.performed -= instance.OnNavigate;
            @Navigate.canceled -= instance.OnNavigate;
        ...
        public void RemoveCallbacks(ILeftMenuActions instance)
        {
            if (m_Wrapper.m_LeftMenuActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ILeftMenuActions instance)
        {
            foreach (var item in m_Wrapper.m_LeftMenuActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_LeftMenuActionsCallbackInterfaces.Clear();
    ...
    private List<IDialogModalActions> m_DialogModalActionsCallbackInterfaces = new List<IDialogModalActions>();
    ...
    public struct DialogModalActions
    {
        ...
        public void AddCallbacks(IDialogModalActions instance)
        {
            if (instance == null || m_Wrapper.m_DialogModalActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_DialogModalActionsCallbackInterfaces.Add(instance);
            @Navigate.started += instance.OnNavigate;
            @Navigate.performed += instance.OnNavigate;
            @Navigate.canceled += instance.OnNavigate;
            @Select.started += instance.OnSelect;
        ...
        private void UnregisterCallbacks(IDialogModalActions instance)
        {
            @Navigate.started -= instance.OnNavigate;
            @Navigate.performed -= instance.OnNavigate;
            @Navigate.canceled -= instance.OnNavigate;
        ...
        public void RemoveCallbacks(IDialogModalActions instance)
        {
            if (m_Wrapper.m_DialogModalActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IDialogModalActions instance)
        {
            foreach (var item in m_Wrapper.m_DialogModalActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_DialogModalActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
