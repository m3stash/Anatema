...
public class GLDebug : MonoBehaviour {
...
#endif
    public Rect rect = new Rect(0, 0, 150, 20);
    ...
    void SetMaterial() {
        var shaderOn = Shader.Find("Unlit/GLlineZOn");
        matZOn = new Material(shaderOn);
        var shaderOff = Shader.Find("Unlit/GLlineZOff");
        matZOff = new Material(shaderOff);
    }
